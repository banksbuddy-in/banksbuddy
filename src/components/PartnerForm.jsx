        ...
        >
            <div className="hsoaiof">
                <form className="ac-frm" onSubmit={handleSubmit}>
                    <h1 className="tgfrm">Join our Network.</h1>
                ...
                <img src="/pn.png" alt="Partner with us" className="consult" style={{ objectFit: 'contain' }} />
            </div>
            {status && <p className="sactatus" style={{ textAlign: "center", marginTop: "1rem", color: "var(--bl)", fontWeight: "bold" }}>{status}</p>}
        </motion.div>
    );
};
